...
def main(opt) :
    ...
    train_loader, val_loader, _, _ = get_dataloader(opt, "dataset/HCMC-vehicle-dataset.csv")
    ...
    # Create Directory
    ckpt_dir, graph_dir = f"ckpt/lstm/{opt.loss_function}", f"result/lstm/{opt.loss_function}"
